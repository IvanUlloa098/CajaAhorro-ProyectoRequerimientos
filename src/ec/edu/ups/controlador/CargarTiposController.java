...
/**
 * Servlet implementation class CargarTiposController
 */
@WebServlet("/CargarTiposController")
public class CargarTiposController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			url= "/emp/realizarTransaccion.jsp";
		} catch (Exception e) {
			e.printStackTrace();
		}
