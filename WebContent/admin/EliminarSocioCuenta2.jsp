...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>Eliminar cuenta ahorros</title>  
...
<body class="seo_version">
    ...
    <div id="services" class="section lb">
        <div class="container-fluid">
			...
			<c:set var="listadoC" scope="request" value="${cuentas}" />
			<c:set var="cedula" scope="request" value="${cedula}" />
			
			<table class="table">
				<tr>
					<td class="titulo"><strong>Numero de Cuenta</strong></td>
					<td class="titulo"><strong> Estado</strong></td>
					<td class="titulo"><strong>Plan de Cuenta</strong></td>
				...
				<c:forEach var="c" items="${listadoC}">
					<tr>
						<td>${c.numero}</td>
						<td>Activo</td>
						<td>${c.planesCuentas.descrip}</td>
						<td> <a href="/CajaAhorro-ProyectoRequerimientos/EliminarSocioCuentaController2?numero=${c.numero}&cedula=${cedula}"> Eliminar Cuenta</a> </td>
					</tr>
				</c:forEach>
			</table>
			<br>
			<br>
			<br>
		    <form method="POST" action="/CajaAhorro-ProyectoRequerimientos/EliminarSocioCuentaController2">
