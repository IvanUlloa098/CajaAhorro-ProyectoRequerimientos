    ...
    <div id="services" class="section lb">
        <div class="container-fluid">
			<div class="container">
				...
				<c:set var="s" scope="request" value="${usuario}" />
				
					<form id="contactform04" class="container"  method="POST" action="/CajaAhorro-ProyectoRequerimientos/EditarSocioDatosController2" name="contactform">
                            <fieldset>
                            ...
                            <legend>Datos</legend>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="cedula" id="cedula" class="form-control" value=${s.cedula} >
                                </div>
                                
                                
                                
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="nombre" id="nombre" class="form-control" value=${s.nombre}>
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="apellido" id="apellido" class="form-control" value=${s.apellido}>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                 ...
                                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="direccion" id="direccion" class="form-control" value=${s.direccion}>
                                </div>
                                
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="telefono" id="telefono" class="form-control" value=${s.telefono}>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="username" id="username" class="form-control" value=${s.username}>
                                </div>
                                
                                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="password" id="password" class="form-control" value=${s.password}>
                                </div>
                            ...
                            <br><BR />
                            <input class="container" type="submit" id="login" name="login" value="Editar" />
                            <br><BR />
                          </fieldset>      
                        </form>
                        
                        
                    <form method="GET" action="/CajaAhorro-ProyectoRequerimientos/EditarSocioDatosController2">
