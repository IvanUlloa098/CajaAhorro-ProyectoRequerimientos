...
<body class="seo_version">
	...
	<c:set var="s" scope="request" value="${socio}" />
        ...
        <div class="container-fluid">
			<div class="container">
				<div class="row">
					...
					<form id="contactform04" class="container"  method="POST" action="/CajaAhorro-ProyectoRequerimientos/EditarSocioController" name="contactform">
                            <fieldset>
                            ...
                            <legend>Informacion Personal</legend>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="nombre" id="nombre" class="form-control" value="${s.getNombre()}" placeholder="Nombre.....">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="apellido" id="apellido" class="form-control" value="${s.getApellido()}" placeholder="Apellido.....">
                                </div>
                                <br><BR />
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="cedula" id="cedula" class="form-control" value="${s.getCedula()}" placeholder="Cedula.....">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="telefono" id="telefono" class="form-control" value="${s.getTelefono()}" placeholder="Telefono.....">
                                </div>
                                <br><BR />
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="direccion" id="direccion" class="form-control" value="${s.getDireccion()}" placeholder="Direccion.....">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="email" id="email" class="form-control" value="${s.getEmail()}" placeholder="Email.....">
                                </div>
                                <br><BR />
                            </fieldset>
                            
                            <br><BR />
                            <input class="container" type="submit" id="login" name="login" value="Editar Socio" />
                            <br><BR />
                          </fieldset>      
                        </form>
				</div>
