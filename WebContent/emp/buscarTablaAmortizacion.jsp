			...
			<div class="container">
				<div class="row">
					<div class="section-title text-center">
						...
						<p>La tabla de amortización nos sirve para conocer cómo dividirán los pagos de tu crédito. </p>
						<p>En otras palabras, es el plan de pago de deuda al obtener un crédito.</p>
					</div><!-- end title -->
					<form id="contactform04" class="container"  method="GET" action="/CajaAhorro-ProyectoRequerimientos/BuscarTablaAmortizacion" name="contactform">
                            <fieldset>
                            ...
                            <legend>Informacion Necesaria</legend>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="cedula" id="cedula" class="form-control" placeholder="Cedula del propietario...">
                                </div>                                
                                <br><BR />         
                                
                            </fieldset>
                            
                            <input class="container" type="submit" id="login" name="login" value="Consultar" />
                            <br><BR />
                          </fieldset>      
                        </form>
				</div>
