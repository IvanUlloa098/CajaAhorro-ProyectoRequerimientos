				...
				<div class="row">
					...
					<form id="contactform04" class="container"  method="GET" action="/CajaAhorro-ProyectoRequerimientos/PagoCuotasController" name="contactform">
                            ...
                            <legend>Informacion Necesaria</legend>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" name="cuota" id="cuota" class="form-control" placeholder="Cuota a pagar...">
                                </div>
                                
                                <br><BR />                                 
                            </fieldset>
                            
                            <input class="container" type="submit" id="login" name="login" value="Realizar Pago de Cuota" />
                            <br><BR />
                          </fieldset>      
                        </form>
				</div>
