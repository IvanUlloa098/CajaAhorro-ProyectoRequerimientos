        ...
        <div class="container-fluid">
			<div class="container">
				<div class="row">
					...
					<form id="contactform04" class="container"  method="POST" action="/CajaAhorro-ProyectoRequerimientos/TransferenciaController" name="contactform">
                            <fieldset>
                            <fieldset class="row row-fluid">
                            <legend>Informacion Necesaria</legend>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                	
                                    <input type="text" name="cuenta1" id="cuenta" class="form-control" placeholder="Numero de Cuenta del remitente...">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <input type="number"step="0.01"  name="monto" id="monto" class="form-control" placeholder="Monto del Movimiento...">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                	
                                    <input type="text" name="cuenta2" id="cuenta" class="form-control" placeholder="Numero de Cuenta del recipiente...">
                                </div>
                                <br><BR />                               
                            ...
                            <input class="container" type="submit" id="login" name="login" value="Realizar Transferencia" />
                            <br><BR />
                          </fieldset>      
                        </form>
				</div>
